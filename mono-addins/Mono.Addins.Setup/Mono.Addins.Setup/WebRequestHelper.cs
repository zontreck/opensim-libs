...
{
    private static Func<Func<HttpWebRequest>, Action<HttpWebRequest>, CancellationToken, HttpWebResponse> _handler;

    internal static bool HasCustomRequestHandler => _handler != null;
    ...
    public static void SetRequestHandler(
        Func<Func<HttpWebRequest>, Action<HttpWebRequest>, CancellationToken, HttpWebResponse> handler)
    {
        _handler = handler;
    }
    ...
    ///     requires authentication and the user has stopped trying to enter them (i.e. they hit cancel when they are
    ///     prompted).
    /// </remarks>
