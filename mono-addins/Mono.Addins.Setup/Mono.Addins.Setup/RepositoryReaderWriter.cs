...
internal class RepositoryReader : XmlSerializationReader
{
    ...
    public Repository ReadObject_Repository(bool isNullable, bool checkType)
    {
        Repository ob = null;
        ...
        ob = (Repository)Activator.CreateInstance(typeof(Repository), true);
        ...
        RepositoryEntryCollection o5;
        o5 = ob.Repositories;
        RepositoryEntryCollection o7;
        o7 = ob.Addins;
        int n4 = 0, n6 = 0;
        ...
        while (Reader.NodeType != XmlNodeType.EndElement)
        {
            if (Reader.NodeType == XmlNodeType.Element)
            {
                ...
                {
                    b1 = true;
                    var s9 = Reader.ReadElementString();
                    ob.Url = s9;
                }
                else
                {
    ...
    public PackageRepositoryEntry ReadObject_PackageRepositoryEntry(bool isNullable, bool checkType)
    {
        PackageRepositoryEntry ob = null;
        if (isNullable && ReadNull()) return null;
        ...
        ob = (PackageRepositoryEntry)Activator.CreateInstance(typeof(PackageRepositoryEntry), true);
        ...
        while (Reader.NodeType != XmlNodeType.EndElement)
        {
            if (Reader.NodeType == XmlNodeType.Element)
            {
                ...
                {
                    b10 = true;
                    var s12 = Reader.ReadElementString();
                    ob.Url = s12;
                }
                else
                {
    ...
    public ReferenceRepositoryEntry ReadObject_ReferenceRepositoryEntry(bool isNullable, bool checkType)
    {
        ReferenceRepositoryEntry ob = null;
        if (isNullable && ReadNull()) return null;
        ...
        ob = (ReferenceRepositoryEntry)Activator.CreateInstance(typeof(ReferenceRepositoryEntry), true);
        ...
        while (Reader.NodeType != XmlNodeType.EndElement)
        {
            if (Reader.NodeType == XmlNodeType.Element)
            {
                ...
                {
                    b13 = true;
                    var s15 = Reader.ReadElementString();
                    ob.Url = s15;
                }
    ...
    public AddinInfo ReadObject_AddinInfo(bool isNullable, bool checkType)
    {
        AddinInfo ob = null;
        if (isNullable && ReadNull()) return null;
        ...
        ob = (AddinInfo)Activator.CreateInstance(typeof(AddinInfo), true);
        ...
        while (Reader.NodeType != XmlNodeType.EndElement)
        {
            if (Reader.NodeType == XmlNodeType.Element)
            {
                ...
                {
                    b20 = true;
                    var s30 = Reader.ReadElementString();
                    ob.Version = s30;
                }
                        ...
                        while (Reader.NodeType != XmlNodeType.EndElement)
                        {
                            if (Reader.NodeType == XmlNodeType.Element)
                            {
                                if (Reader.LocalName == "Property" && Reader.NamespaceURI == "")
                                {
                                    if (ob.Properties == null)
                                        throw CreateReadOnlyCollectionException(
                                            "Mono.Addins.Setup.AddinPropertyCollectionImpl");
                ...
                {
                    b18 = true;
                    var s41 = Reader.ReadElementString();
                    ob.Namespace = s41;
                }
                else if (Reader.LocalName == "Category" && Reader.NamespaceURI == "" && !b26)
                {
                    b26 = true;
                    var s42 = Reader.ReadElementString();
                    ob.Category = s42;
                }
                else
                {
    ...
    public AssemblyDependency ReadObject_AssemblyDependency(bool isNullable, bool checkType)
    {
        AssemblyDependency ob = null;
        if (isNullable && ReadNull()) return null;
        ...
        ob = (AssemblyDependency)Activator.CreateInstance(typeof(AssemblyDependency), true);
        ...
        while (Reader.NodeType != XmlNodeType.EndElement)
        {
            if (Reader.NodeType == XmlNodeType.Element)
            {
                ...
                {
                    b44 = true;
                    var s45 = Reader.ReadElementString();
                    ob.Package = s45;
                }
                else if (Reader.LocalName == "FullName" && Reader.NamespaceURI == "" && !b43)
                {
                    b43 = true;
                    var s46 = Reader.ReadElementString();
                    ob.FullName = s46;
                }
                else
                {
...
#pragma warning disable CS0612 // Type or member is obsolete
    ...
    public NativeDependency ReadObject_NativeReference(bool isNullable, bool checkType)
    {
        NativeDependency ob = null;
        if (isNullable && ReadNull()) return null;
        ...
        ob = (NativeDependency)Activator.CreateInstance(typeof(NativeDependency), true);
...
#pragma warning restore CS0612 // Type or member is obsolete
    ...
    public AddinDependency ReadObject_AddinReference(bool isNullable, bool checkType)
    {
        AddinDependency ob = null;
        if (isNullable && ReadNull()) return null;
        ...
        ob = (AddinDependency)Activator.CreateInstance(typeof(AddinDependency), true);
        ...
        while (Reader.NodeType != XmlNodeType.EndElement)
        {
            if (Reader.NodeType == XmlNodeType.Element)
            {
                ...
                {
                    b48 = true;
                    var s49 = Reader.ReadElementString();
                    ob.Version = s49;
                }
                else if (Reader.LocalName == "AddinId" && Reader.NamespaceURI == "" && !b47)
                {
                    b47 = true;
                    var s50 = Reader.ReadElementString();
                    ob.AddinId = s50;
                }
                else
                {
    ...
    public AddinProperty ReadObject_AddinProperty(bool isNullable, bool checkType)
    {
        AddinProperty ob = null;
        if (isNullable && ReadNull()) return null;
        ...
        ob = (AddinProperty)Activator.CreateInstance(typeof(AddinProperty), true);
...
internal class RepositoryWriter : XmlSerializationWriter
{
    ...
    private void WriteObject_Repository(Repository ob, string element, string namesp, bool isNullable, bool needType,
        bool writeWrappingElem)
    {
        ...
        if (ob.Repositories != null)
            for (var n51 = 0; n51 < ob.Repositories.Count; n51++)
                WriteObject_ReferenceRepositoryEntry((ReferenceRepositoryEntry)ob.Repositories[n51], "Repository", "",
                    false, false, true);
        if (ob.Addins != null)
            for (var n52 = 0; n52 < ob.Addins.Count; n52++)
                WriteObject_PackageRepositoryEntry((PackageRepositoryEntry)ob.Addins[n52], "Addin", "", false, false,
                    true);
        if (writeWrappingElem) WriteEndElement(ob);
    }

    private void WriteObject_ReferenceRepositoryEntry(ReferenceRepositoryEntry ob, string element, string namesp,
        bool isNullable, bool needType, bool writeWrappingElem)
    {
        ...
        var type = ob.GetType();
        if (type == typeof(ReferenceRepositoryEntry))
        {
        }
        else
        {
    ...
    private void WriteObject_PackageRepositoryEntry(PackageRepositoryEntry ob, string element, string namesp,
        bool isNullable, bool needType, bool writeWrappingElem)
    {
        if (ob == null)
        {
        ...
        var type = ob.GetType();
        if (type == typeof(PackageRepositoryEntry))
        {
        }
        else
        {
    ...
    private void WriteObject_AddinInfo(AddinInfo ob, string element, string namesp, bool isNullable, bool needType,
        bool writeWrappingElem)
    {
        if (ob == null)
        {
        ...
        if (ob.Dependencies != null)
        {
            ...
            for (var n53 = 0; n53 < ob.Dependencies.Count; n53++)
                if (ob.Dependencies[n53] == null)
                {
                }
                else if (ob.Dependencies[n53].GetType() == typeof(AssemblyDependency))
                {
                    WriteObject_AssemblyDependency((AssemblyDependency)ob.Dependencies[n53], "AssemblyDependency", "",
                        false, false, true);
                }
#pragma warning disable CS0612
                // Type or member is obsolete
                else if (ob.Dependencies[n53].GetType() == typeof(NativeDependency))
                {
                    WriteObject_NativeReference((NativeDependency)ob.Dependencies[n53], "NativeDependency", "", false,
                        false, true);
                }
#pragma warning restore CS0612
                // Type or member is obsolete
                else if (ob.Dependencies[n53].GetType() == typeof(AddinDependency))
                {
                    WriteObject_AddinReference((AddinDependency)ob.Dependencies[n53], "AddinDependency", "", false,
                        false, true);
                }
                else
                {
                    throw CreateUnknownTypeException(ob.Dependencies[n53]);
                }
        ...
        if (ob.OptionalDependencies != null)
        {
            ...
            for (var n54 = 0; n54 < ob.OptionalDependencies.Count; n54++)
                if (ob.OptionalDependencies[n54] == null)
                {
                }
                else if (ob.OptionalDependencies[n54].GetType() == typeof(AssemblyDependency))
                {
                    WriteObject_AssemblyDependency((AssemblyDependency)ob.OptionalDependencies[n54],
                        "AssemblyDependency", "", false, false, true);
                }
#pragma warning disable CS0612
                // Type or member is obsolete
                else if (ob.OptionalDependencies[n54].GetType() == typeof(NativeDependency))
                {
                    WriteObject_NativeReference((NativeDependency)ob.OptionalDependencies[n54], "NativeDependency", "",
                        false, false, true);
                }
#pragma warning restore CS0612
                // Type or member is obsolete
                else if (ob.OptionalDependencies[n54].GetType() == typeof(AddinDependency))
                {
                    WriteObject_AddinReference((AddinDependency)ob.OptionalDependencies[n54], "AddinDependency", "",
                        false, false, true);
                }
                else
                {
                    throw CreateUnknownTypeException(ob.OptionalDependencies[n54]);
                }
        ...
        if (ob.Properties != null)
        {
            ...
            for (var n55 = 0; n55 < ob.Properties.Count; n55++)
    ...
    private void WriteObject_AssemblyDependency(AssemblyDependency ob, string element, string namesp, bool isNullable,
        bool needType, bool writeWrappingElem)
    {
        ...
        var type = ob.GetType();
        if (type == typeof(AssemblyDependency))
        {
        }
        else
        {
...
#pragma warning disable CS0612 // Type or member is obsolete
    ...
    private void WriteObject_NativeReference(NativeDependency ob, string element, string namesp, bool isNullable,
        bool needType, bool writeWrappingElem)
    {
        if (ob == null)
        {
        ...
        var type = ob.GetType();
        if (type == typeof(NativeDependency))
        {
        }
        else
        {
...
#pragma warning restore CS0612 // Type or member is obsolete
    ...
    private void WriteObject_AddinReference(AddinDependency ob, string element, string namesp, bool isNullable,
        bool needType, bool writeWrappingElem)
    {
        if (ob == null)
        {
        ...
        var type = ob.GetType();
        if (type == typeof(AddinDependency))
        {
        }
        else
        {
    ...
    private void WriteObject_AddinProperty(AddinProperty ob, string element, string namesp, bool isNullable,
        bool needType, bool writeWrappingElem)
    {
        if (ob == null)
        {
