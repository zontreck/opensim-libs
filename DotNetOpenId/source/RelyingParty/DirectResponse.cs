...
{
    protected DirectResponse(OpenIdRelyingParty relyingParty, ServiceEndpoint provider,
        IDictionary<string, string> args)
    {
        ...
        var detectedProtocol = Protocol.DetectFromDirectResponse(args).ProtocolVersion;
