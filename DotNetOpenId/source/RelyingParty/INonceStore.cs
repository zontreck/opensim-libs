...
public interface INonceStore
{
	...
	///         and the ExpirationDate for rapid deletion of expired nonces.
	///     </para>
	...
	///     <para>
	///         Checking for the prior existence of the given nonce and adding the nonce if it
	...
	///         can add a given nonce once you've verified that it's not there.
	///     </para>
	/// </remarks>
	...
	/// </remarks>
	[SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Nonces")]
