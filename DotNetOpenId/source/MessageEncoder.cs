...
internal class MessageEncoder
{
    ...
    private const string FormPostFormat = @"
<html>
...
";
    ...
    public virtual Response Encode(IEncodable message)
    {
        ...
        var encode_as = message.EncodingType;
        Response wr;
        ...
        switch (encode_as)
        {
            case EncodingType.DirectResponse:
                ...
                var code = message is Exception ? HttpStatusCode.BadRequest : HttpStatusCode.OK;
                ...
                wr = new Response(code, headers, ProtocolMessages.KeyValueForm.GetBytes(message.EncodedFields),
                    message);
                break;
    ...
    private static int getSizeOfPayload(IEncodable message)
    {
    ...
    {
        var headers = new WebHeaderCollection();
        var builder = new UriBuilder(message.RedirectUrl);
    ...
    protected virtual Response CreateFormPostResponse(IEncodable message)
    {
        ...
        var bodyWriter = new StreamWriter(body);
