...
internal class Associations
{
    ...
    private Dictionary<string, Association> assocs;
    ...
    public Associations()
    {
        assocs = new Dictionary<string, Association>();
    }
    ...
    public Association Best
    {
        get
        {
            lock (this)
            {
                ...
                foreach (var assoc in assocs.Values)
    ...
    public void Set(Association association)
    {
        ...
        lock (this)
        {
            assocs[association.Handle] = association;
        }
    }
