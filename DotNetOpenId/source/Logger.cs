...
{
    private static readonly ILog facade = initializeFacade();

    private static ILog initializeFacade()
    {
        var result = Log4NetLogger.Initialize() ?? NoOpLogger.Initialize();
    ...
    */
    ...
    public static bool IsDebugEnabled => facade.IsDebugEnabled;

    public static bool IsInfoEnabled => facade.IsInfoEnabled;

    public static bool IsWarnEnabled => facade.IsWarnEnabled;

    public static bool IsErrorEnabled => facade.IsErrorEnabled;

    public static bool IsFatalEnabled => facade.IsFatalEnabled;
