...
internal class Protocol
{
    ...
    public static readonly Protocol v10 = new(new QueryParameters())
    {
    ...
    public static readonly Protocol v11 = new(new QueryParameters())
    {
    ...
    public static readonly Protocol v20 = new(new QueryParameters
    {
        Realm = "realm",
    ...
    /// </summary>
    public static readonly List<Protocol> AllVersions = new() { v20, v11, v10 };
    ...
    /// </summary>
    public QueryArguments Args = new();
    ...
    {
        foreach (var protocol in AllVersions)
    ...
    public static Protocol Lookup(ProtocolVersion version)
    {
        switch (version)
        {
            case ProtocolVersion.V10: return v10;
            case ProtocolVersion.V11: return v11;
            case ProtocolVersion.V20: return v20;
    ...
    {
        public ErrorCodes ErrorCode = new();
        public IsValidValues IsValid = new();
        public Modes Mode = new();
        public SessionTypes SessionType = new();
        public SignatureAlgorithms SignatureAlgorithm = new();
        ...
        internal class SessionTypes
        {
            ...
            public string[] All
            {
                get { return new[] { DH_SHA512, DH_SHA384, DH_SHA256, DH_SHA1, NoEncryption }; }
            }

            public string[] AllDiffieHellman
            {
                get { return new[] { DH_SHA512, DH_SHA384, DH_SHA256, DH_SHA1 }; }
            }
            ...
            public string Best
            {
                get
                {
                    foreach (var algorithmName in All)
        ...
        internal class SignatureAlgorithms
        {
            ...
            public string[] All
            {
                get { return new[] { HMAC_SHA512, HMAC_SHA384, HMAC_SHA256, HMAC_SHA1 }; }
            }
