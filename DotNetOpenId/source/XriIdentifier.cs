...
public sealed class XriIdentifier : Identifier
{
    ...
    private XrdsDocument downloadXrds()
    {
        ...
        var doc = new XrdsDocument(XmlReader.Create(xrdsResponse.ResponseStream));
        if (!doc.IsXrdResolutionSuccessful) throw new OpenIdException(Strings.XriResolutionFailed);
        return doc;
    }
    ...
    {
        var other = obj as XriIdentifier;
        if (other == null) return false;
        return CanonicalXri == other.CanonicalXri;
    }
