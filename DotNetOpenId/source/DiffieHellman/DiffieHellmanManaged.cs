...
internal sealed class DiffieHellmanManaged : DiffieHellman
{
    ...
    private readonly byte[] m_OAKLEY1024 =
    {
    ...
    private readonly byte[] m_OAKLEY1536 =
    {
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2,
        0x21, 0x68, 0xC2, 0x34, 0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1,
        0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74, 0x02, 0x0B, 0xBE, 0xA6,
    ...
    private readonly byte[] m_OAKLEY768 =
    {
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2,
        0x21, 0x68, 0xC2, 0x34, 0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1,
        0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74, 0x02, 0x0B, 0xBE, 0xA6,
    ...
    /// <remarks>
    ///     The larger the bit length, the more secure the algorithm is. The default is 1024 bits. The minimum bit length
    ///     is 128 bits.<br />The size of the private value will be one fourth of the bit length specified.
    /// </remarks>
    ...
    /// <param name="x">
    ///     The X parameter of the Diffie-Hellman algorithm. This is a private parameter. If this parameters is a
    ///     null reference (<b>Nothing</b> in Visual Basic), a secret value of the default size will be generated.
    /// </param>
    ...
    public override string KeyExchangeAlgorithm => "1.2.840.113549.1.3"; // PKCS#3 OID
    ...
    public override DHParameters ExportParameters(bool includePrivateParameters)
    {
        ...
        ret.P = m_P.getBytes();
        ret.G = m_G.getBytes();
        if (includePrivateParameters) ret.X = m_X.getBytes();
        return ret;
    }
    ...
    public override void ImportParameters(DHParameters parameters)
    {
        ...
        BigInteger p = new(parameters.P), g = new(parameters.G), x = null;
        if (parameters.X != null) x = new BigInteger(parameters.X);
