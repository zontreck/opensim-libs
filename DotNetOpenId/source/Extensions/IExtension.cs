...
public interface IExtensionRequest : IExtension
{
	...
	/// </summary>
	IDictionary<string, string> Serialize(IAuthenticationRequest authenticationRequest);
	...
	///     false otherwise.
	/// </returns>
	bool Deserialize(IDictionary<string, string> fields, IRequest request, string typeUri);
}
...
public interface IExtensionResponse : IExtension
{
	...
	/// </summary>
	IDictionary<string, string> Serialize(IRequest authenticationRequest);
	...
	///     false otherwise.
	/// </returns>
	bool Deserialize(IDictionary<string, string> fields, IAuthenticationResponse response, string typeUri);
}