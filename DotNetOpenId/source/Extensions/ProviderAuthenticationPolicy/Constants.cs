...
internal static class Constants
{
    ...
    internal static class RequestParameters
    {
	    ...
	    /// <summary>
	    ///     The space separated list of the name spaces of the custom Assurance Level that RP requests, in the order of its
	    ///     preference.
	    /// </summary>
    ...
    internal static class ResponseParameters
    {
	    ...
	    /// </summary>
	    /// <value>
	    ///     The timestamp MUST be formatted as specified in section 5.6 of [RFC3339] (Klyne, G. and C. Newman, “Date and Time
	    ///     on the Internet: Timestamps,” .), with the following restrictions:
