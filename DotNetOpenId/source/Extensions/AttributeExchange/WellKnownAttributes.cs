...
public static class WellKnownAttributes
{
    ...
    public static class Preferences
    {
        ...
        /// <summary>
        ///     Home time zone information (as specified in
        ///     <a href="http://en.wikipedia.org/wiki/List_of_tz_zones_by_name">zoneinfo</a>)
        /// </summary>
    ...
    public static class Media
    {
        ...
        public static class Images
        {
            ...
            /// <summary>
            ///     Image (web URL); favicon format as per FAVICON-W3C. The format for the image must be 16x16 pixels or 32x32
            ///     pixels, using either 8-bit or 24-bit colors. The format of the image must be one of PNG (a W3C standard), GIF, or
            ///     ICO.
            /// </summary>
            /// <example>"http://example.com/~jsmith/image.jpg"</example>
