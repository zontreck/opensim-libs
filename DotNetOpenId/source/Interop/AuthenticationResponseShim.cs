...
public class AuthenticationResponseShim
{
    ...
    ///     </para>
    /// </remarks>
    public string ClaimedIdentifier => response.ClaimedIdentifier;
    ...
    ///     </para>
    /// </remarks>
    public string FriendlyIdentifierForDisplay => response.FriendlyIdentifierForDisplay;

    /// <summary>
    ///     A value indicating whether the authentication attempt succeeded.
    /// </summary>
    public bool Successful => response.Status == AuthenticationStatus.Authenticated;

    /// <summary>
    ///     Details regarding a failed authentication attempt, if available.
    /// </summary>
    public string ExceptionMessage => response.Exception != null ? response.Exception.Message : null;
}