...
internal class RelyingPartyReceivingEndpoint
{
    ...
    /// </summary>
    private readonly string[] supportedServiceTypeUris;
    ...
    public Protocol Protocol
    {
        get
        {
            if (protocol == null) protocol = Util.FindBestVersion(p => p.RPReturnToTypeURI, supportedServiceTypeUris);
            if (protocol != null) return protocol;
            throw new InvalidOperationException(
                "Unable to determine the version of OpenID the Relying Party supports.");
        }
    }
}