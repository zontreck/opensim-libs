...
/* Data storage for OSTerrain data.*/
struct dxOSTerrainData;
typedef struct dxOSTerrainData* dxOSTerrainDataID;
...
struct dxOSTerrainData;
typedef struct dxOSTerrainData* dOSTerrainDataID;

typedef dReal dOSTerrainGetHeight( void* p_user_data, int x, int z );

ODE_API dGeomID dCreateOSTerrain( dSpaceID space,
					dOSTerrainDataID data, int bPlaceable );

ODE_API dOSTerrainDataID dGeomOSTerrainDataCreate(void);

ODE_API void dGeomOSTerrainDataDestroy( dOSTerrainDataID d );

ODE_API void dGeomOSTerrainDataBuild( dOSTerrainDataID d,
				const float* pHeightData, int bCopyHeightData,
				dReal SamplesSize, int widthSamples, int depthSamples,
				dReal thickness, int bWrap );

ODE_API void dGeomOSTerrainDataSetBounds( dOSTerrainDataID d,
				dReal minHeight, dReal maxHeight );


ODE_API void dGeomOSTerrainSetData( dGeomID g, dOSTerrainDataID d );


ODE_API dOSTerrainDataID dOSTerrainGetData( dGeomID g );
