...
internal sealed class ImageWriter : BinaryStreamWriter
{
    ...
    {
        var writer = new ImageWriter(module, module.runtime_version, metadata, stream, false);
    ...
    public void BuildMetadataTextMap()
    {
        ...
        map.AddMap(TextSegment.UserStringHeap, metadata.user_string_heap.IsEmpty ? 0 : metadata.user_string_heap.length,
            4);
