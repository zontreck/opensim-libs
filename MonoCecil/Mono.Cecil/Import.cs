...
public class DefaultReflectionImporter : IReflectionImporter
{
    ...
    private MethodReference ImportMethodSpecification(SR.MethodBase method, ImportGenericContext context)
    {
        ...
        var element_method =
            ImportMethod(method_info.GetGenericMethodDefinition(), context, ImportGenericKind.Definition);
...
internal static partial class Mixin
{
    ...
    public static bool TryGetAssemblyNameReference(this ModuleDefinition module, AssemblyNameReference name_reference,
