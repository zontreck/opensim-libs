...
public sealed class WriterParameters
{
    ...
    public bool HasStrongNameKey =>
        StrongNameKeyPair != null || StrongNameKeyBlob != null || StrongNameKeyContainer != null;
    ...
    IDisposable
{
    ...
    [Obsolete("Use FileName")] public string FullyQualifiedName => FileName;
    ...
    public void ReadSymbols()
    {
        ...
        ReadSymbols(provider.GetSymbolReader(this, FileName), true);
    }
