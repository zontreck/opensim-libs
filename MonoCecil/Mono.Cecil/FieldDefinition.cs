...
public sealed class FieldDefinition : FieldReference, IMemberDefinition, IConstantProvider, IMarshalInfoProvider
{
    ...
    {
        get => attributes.GetMaskedAttributes((ushort)FieldAttributes.FieldAccessMask, (ushort)FieldAttributes.Private);
        set => attributes = attributes.SetMaskedAttributes((ushort)FieldAttributes.FieldAccessMask,
    ...
    {
        get =>
            attributes.GetMaskedAttributes((ushort)FieldAttributes.FieldAccessMask, (ushort)FieldAttributes.Assembly);
        set => attributes = attributes.SetMaskedAttributes((ushort)FieldAttributes.FieldAccessMask,
    ...
    {
        get => attributes.GetMaskedAttributes((ushort)FieldAttributes.FieldAccessMask, (ushort)FieldAttributes.Family);
        set => attributes = attributes.SetMaskedAttributes((ushort)FieldAttributes.FieldAccessMask,
    ...
    {
        get => attributes.GetMaskedAttributes((ushort)FieldAttributes.FieldAccessMask, (ushort)FieldAttributes.Public);
        set => attributes = attributes.SetMaskedAttributes((ushort)FieldAttributes.FieldAccessMask,
