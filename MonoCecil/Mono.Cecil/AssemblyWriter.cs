...
internal static class ModuleWriter
{
    ...
    {
        var previousPosition = writer.BaseStream.Position;
        ...
        var guid = CryptoService.ComputeGuid(CryptoService.ComputeHash(writer.BaseStream));
...
internal sealed class MetadataBuilder
{
    ...
    private TextMap CreateTextMap()
    {
        ...
        var pe64 = module.Architecture == TargetArchitecture.AMD64 || module.Architecture == TargetArchitecture.IA64 ||
    ...
    private void AddCustomDebugInformation(ICustomDebugInformationProvider provider, CustomDebugInformation custom_info,
