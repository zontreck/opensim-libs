...
internal sealed class WindowsRuntimeProjections
{
    ...
    private static Dictionary<string, ProjectionInfo> Projections
    {
        get
        {
            ...
            var new_projections = new Dictionary<string, ProjectionInfo>
            {
                ...
                {
                    "IIterable`1",
                    new ProjectionInfo("Windows.Foundation.Collections", "System.Collections.Generic", "IEnumerable`1",
                        "System.Runtime")
                },
                {
                    "IKeyValuePair`2",
                    new ProjectionInfo("Windows.Foundation.Collections", "System.Collections.Generic", "KeyValuePair`2",
                        "System.Runtime")
                },
                {
                    "IMapView`2",
                ...
                {
                    "IMap`2",
                    new ProjectionInfo("Windows.Foundation.Collections", "System.Collections.Generic", "IDictionary`2",
                        "System.Runtime")
                },
                {
                ...
                {
                    "KeyTime",
                    new ProjectionInfo("Windows.UI.Xaml.Media.Animation", "Windows.UI.Xaml.Media.Animation", "KeyTime",
                        "System.Runtime.WindowsRuntime.UI.Xaml")
                },
                {
                    "Matrix",
                ...
                },
                {
                    ...
                    new ProjectionInfo("Windows.UI.Xaml.Data", "System.ComponentModel", "PropertyChangedEventHandler",
                        "System.ObjectModel")
                },
                {
                    "Quaternion",
    ...
    public static void Project(TypeDefinition type)
    {
        ...
        if (type.IsWindowsRuntime)
        {
            ...
            if (treatment == TypeDefinitionTreatment.PrefixWindowsRuntimeName ||
                ...
                if (!type.IsInterface && HasAttribute(type.CustomAttributes, "Windows.UI.Xaml",
    ...
    public static void Project(ICustomAttributeProvider owner, Collection<CustomAttribute> owner_attributes,
