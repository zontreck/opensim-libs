    ...
    ICustomDebugInformationProvider
{
    ...
    public MethodDebugInformation DebugInformation
    {
        get
        {
            ...
            if (debug_info == null) Interlocked.CompareExchange(ref debug_info, new MethodDebugInformation(this), null);
    ...
    public Collection<SecurityDeclaration> SecurityDeclarations =>
        security_declarations ?? this.GetSecurityDeclarations(ref security_declarations, Module);
    ...
    {
        get => impl_attributes.GetAttributes((ushort)MethodImplAttributes.AggressiveOptimization);
        set => impl_attributes =
            impl_attributes.SetAttributes((ushort)MethodImplAttributes.AggressiveOptimization, value);
    }
