...
public sealed class PortablePdbWriterProvider : ISymbolWriterProvider
{
    ...
    public ISymbolWriter GetSymbolWriter(ModuleDefinition module, Stream symbolStream)
    {
        ...
        return GetSymbolWriter(module, Disposable.Owned(new MemoryStream() as Stream),
            Disposable.NotOwned(symbolStream));
    }

    private ISymbolWriter GetSymbolWriter(ModuleDefinition module, Disposable<Stream> stream,
        Disposable<Stream> final_stream)
    {
...
public sealed class PortablePdbWriter : ISymbolWriter
{
    ...
    private readonly MetadataBuilder module_metadata;
    ...
    public ImageDebugHeader GetDebugHeader()
    {
        ...
        ImageDebugHeaderEntry pdbChecksumEntry;
        {
            ...
            buffer.WriteBytes(Encoding.UTF8.GetBytes("SHA256"));
            buffer.WriteByte(0);
        ...
        return new ImageDebugHeader(new[] { codeViewEntry, pdbChecksumEntry });
    }
...
public sealed class EmbeddedPortablePdbWriter : ISymbolWriter
{
    ...
    public ImageDebugHeader GetDebugHeader()
    {
        var pdbDebugHeader = writer.GetDebugHeader();
        ...
        for (var i = 0; i < pdbDebugHeader.Entries.Length; i++)
